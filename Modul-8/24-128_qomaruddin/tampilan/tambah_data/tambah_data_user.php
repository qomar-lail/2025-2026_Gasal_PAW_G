    ...
    <div class="container d-flex justify-content-center flex-column align-items-center">
        <div class="mt-4 bg-white shadow rounded-3" >
            ...
            <form method="POST" class="row g-3 mx-3 mb-3">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control w-75" id="inputEmail4" name="username" placeholder="Masukkan Username">
                </div>
                ...
                <div class="col-md-9">
                    <input type="password" name="password" class="form-control w-75" id="inputPassword4" placeholder="Masukkan Password">
                </div>
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control w-75" name="nama_user" placeholder="Masukkan Nama User">
                </div>
                ...
                <!-- satu baris -->
                <div class="col-md-3 d-flex justify-content-end">
                    <label for="username" class="form-label">Jenis User</label>
                </div>
                <div class="col-md-9">
                    <select name="jenis_user" id="" class="form-control w-75">
                ...
                <?php require_once __DIR__. "../../../data_base/tambah_data/tambah_data_user.php"?>
            </form>
        </div>
    </div>
</body>
