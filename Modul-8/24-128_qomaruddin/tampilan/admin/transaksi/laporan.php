...
require_once __DIR__."/transaksi/data_base/koneksi.php";
require_once __DIR__."/transaksi/data_base/ambil_data/ambil_data.php";
$no = 1;
session_start();
    ...
    <div class="container d-flex justify-content-center align-items-center flex-column">
        ...
        <div class="w-auto m-3 shadow-sm">
            ...
            <div class="m-2 area-cetak">
                <?php require_once __DIR__. "/transaksi/data_base/ambil_data/ambil_data_filter.php" ?>
            </div>
        </div>
