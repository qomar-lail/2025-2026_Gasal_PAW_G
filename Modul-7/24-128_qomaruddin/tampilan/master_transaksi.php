...
require_once __DIR__."../../data_base/ambil_data/data_transaksi.php";
$no = 1;
?>
    ...
    <div class="container d-flex justify-content-center align-items-center">
        <div class="w-auto m-3 shadow-sm">
            <div class="bg-primary d-flex align-items-center ps-2" style="height: 40px;">
                <p class="fw-bold text-white m-0">Master-Transaksi</p>
            </div>
            <div class="mt-3 d-flex justify-content-end">
                <a href="./report_transaksi.php" class="btn btn-primary">Lihat Laporan Penjual</a>
                <a href="" class="btn btn-success ms-1">Tambah Transaksi</a>
            </div>
            <div class="m-2 ">
