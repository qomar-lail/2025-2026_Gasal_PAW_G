...
if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST["tampilkan"])){
    ...
    $filter_date = "SELECT waktu_transaksi, FORMAT(sum(total),0,'id_ID') AS total FROM transaksi WHERE waktu_transaksi BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY DATE(waktu_transaksi) ORDER BY waktu_transaksi ASC";
